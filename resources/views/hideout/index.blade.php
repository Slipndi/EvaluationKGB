            ...
            <table class="min-w-full divide-y divide-gray-200" id="hideoutsTable">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="relative px-6 py-3"><x-buttons.add href='/hideouts/create' title='create hideouts'/></th>
                ...
                <tbody class="bg-white divide-y divide-gray-200 text-sm">
                    ...
                    <tr>
                        ...
                        <a href="{{route('hideouts.edit', $hideout)}}">
                        ...
                        <form method="POST" action="{{route('hideouts.destroy', $hideout)}}">
                          @csrf
                          @method('DELETE')
                          <button type="submit">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
